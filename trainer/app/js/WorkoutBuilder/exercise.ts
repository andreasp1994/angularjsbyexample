export function ExercisesNavController($scope, WorkoutService, WorkoutBuilderService) {
...
export function ExerciseListController($scope, WorkoutService, $location) {
...
export function ExerciseDetailController($scope, WorkoutService, $routeParams, ExerciseBuilderService, $location) {
