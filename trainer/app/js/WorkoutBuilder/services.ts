import {WorkoutPlan,Exercise} from '../shared/model';
export function WorkoutBuilderService(WorkoutService, $q) {
  var service: any = {};
  var buildingWorkout;
  var newWorkout;
...
export function ExerciseBuilderService(WorkoutService, $q) {
  var service: any = {};
