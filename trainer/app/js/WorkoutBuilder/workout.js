System.register([], function(exports_1, context_1) {
    ...
    function WorkoutListController($scope, WorkoutService, $location) {
    ...
    exports_1("WorkoutListController", WorkoutListController);
    function WorkoutDetailController($scope, WorkoutBuilderService, selectedWorkout, $location, $routeParams, WorkoutService, $q) {
        ...
        $scope.uniqueUserName = function (value) {
            ...
            return WorkoutService
                ...
                .then(function (data) { return $q.reject(); }, function (error) { return true; });
        };
    ...
    exports_1("WorkoutDetailController", WorkoutDetailController);
    return {
        setters:[],
        execute: function() {
            WorkoutListController.$inject = ['$scope', 'WorkoutService', '$location'];
            WorkoutDetailController.$inject = ['$scope', 'WorkoutBuilderService', 'selectedWorkout', '$location', '$routeParams', 'WorkoutService', '$q'];
        }
    }
});
