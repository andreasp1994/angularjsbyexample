...
export function WorkoutListController($scope, WorkoutService, $location) {
...
export function WorkoutDetailController($scope, WorkoutBuilderService, selectedWorkout, $location, $routeParams, WorkoutService, $q) {
