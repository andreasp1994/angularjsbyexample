System.register([], function(exports_1, context_1) {
    ...
    /* Services */
    function workoutHistoryTracker($rootScope, appEvents, localStorageService) {
        var maxHistoryItems = 20 //We only track for last 20 exercise
        , storageKey = "workouthistory", workoutHistory = localStorageService.get(storageKey) || [], currentWorkoutLog = null, service = {};
    ...
    return {
        setters:[],
        execute: function() {
            workoutHistoryTracker.$inject = ['$rootScope', 'appEvents', 'localStorageService'];
        }
    }
});
