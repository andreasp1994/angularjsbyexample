System.register([], function(exports_1, context_1) {
    ...
    exports_1("remoteValidator", remoteValidator);
    ...
    exports_1("updateOnBlur", updateOnBlur);
    ...
    exports_1("busyIndicator", busyIndicator);
    function ajaxButton($compile, $animate) {
        return {
            transclude: true,
            restrict: 'E',
            scope: {
                ...
                if (attr.onClick) {
                    element.on('click', function (event) {
                        scope.$apply(function () {
                            ...
                            if (attr.submitting !== undefined && attr.submitting != null)
                                return; //submitting attribute if there takes priority.
                            if (result.finally) {
                                scope.busy = true;
    ...
    exports_1("ajaxButton", ajaxButton);
    function owlCarousel($compile, $timeout) {
        var owl = null;
        return {
            scope: {
                options: '=',
